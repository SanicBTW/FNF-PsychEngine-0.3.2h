...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		if (!initialized)
		{
			...
			{
				FlxG.sound.playMusic(AssetManager.getAsset('freakyMenu', SOUND, "music"), 0);
		...
		logoBl.frames = AssetManager.getAsset('logoBumpin', SPARROW, "images");
		...
		gfDance.frames = AssetManager.getAsset('gfDanceTitle', SPARROW, "images");
		...
		titleText.frames = AssetManager.getAsset('titleEnter', SPARROW, "images");
		...
		logoSpr = new FlxSprite(0, FlxG.height * 0.4).loadGraphic(AssetManager.getAsset('titlelogo', IMAGE, "images"));
		add(logoSpr);
	...
	{
		var fullText:String = AssetManager.getAsset('introText', TEXT, "data");
	...
	override function update(elapsed:Float)
	{
		...
		if (pressedEnter && !transitioning && skippedIntro)
		{
			...
			FlxG.sound.play(AssetManager.getAsset('confirmMenu', SOUND, 'sounds'), 0.7);
