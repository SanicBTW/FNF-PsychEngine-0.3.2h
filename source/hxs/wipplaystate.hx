...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		var gfVersion = stageBuild.returnGFType();
		...
		{
			case 'limo':
				stageBuild.resetFastCar();
				stageBuild.insert(members.indexOf(gfGroup) - 1, stageBuild.fastCar);

			case 'schoolEvil':
				var evilTrail = new FlxTrail(dad, null, 4, 24, 0.3, 0.069); // nice
				stageBuild.insert(members.indexOf(dadGroup) - 1, evilTrail);
		}
