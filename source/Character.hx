	...
	public function new(x:Float, y:Float, ?character:String = 'bf', ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			default:
				...
				#if STORAGE_ACCESS
				//folder is created but the character path contains "characters/" so instead of using CHARACTERS_DATA as the folder we just use the main folder lol
				var path:String = haxe.io.Path.join([StorageAccess.getFolderPath(MAIN), characterPath]);
				...
				//who uses packers or textures bruh
